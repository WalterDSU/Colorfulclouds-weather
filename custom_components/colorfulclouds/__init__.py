...
LastEditors   : fineemb,dscao,WalterDSU
LastEditTime  : 2025-04-18 20:07:33
'''
"""
...
async def async_setup_entry(hass, config_entry) -> bool:
    ...
    await hass.http.async_register_static_paths([
        StaticPathConfig(ROOT_PATH, hass.config.path("custom_components/" + DOMAIN + "/local"), False)
    ])
    _LOGGER.debug(f"register_static_path: {ROOT_PATH + ':custom_components/colorfulclouds/local'}")
    frontend.add_extra_js_url(hass, ROOT_PATH + '/colorfulclouds-weather-card/colorfulclouds-weather-card-chart.js?ver='+VERSION)
    frontend.add_extra_js_url(hass, ROOT_PATH + '/colorfulclouds-weather-card/colorfulclouds-weather-card-more.js?ver='+VERSION)
    frontend.add_extra_js_url(hass, ROOT_PATH + '/colorfulclouds-weather-card/colorfulclouds-weather-card.js?ver='+VERSION)
